...
public class AccommodationController {
    ...
    @GetMapping("/{id}")
    public ApiResponse<Accommodation> getAccommodationById(@PathVariable("id") int id){
    ...
    @PutMapping("/{id}")
    public ApiResponse<Accommodation> updateAccommodation(@PathVariable("id") int id, @RequestBody @Valid AccommodationRequest accommodationRequest){
        return accommodationService.updateAccommodation(id,accommodationRequest);
    }

    @DeleteMapping("/{id}")
    public ApiResponse<Accommodation> deleteAccommodation(@PathVariable("id") int id){
